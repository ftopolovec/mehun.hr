...
jQuery(document).ready(function($){
	...
	setTimeout(function(){
		$(".certifikati").trigger("configuration", {
			items: {
				visible: 2
			},
			prev: '#certifikati_prev',
			next: '#certifikati_next'
		});
	}, 1000);
	...
	$(window).bind("hashchange", function(event){
		...
		$(".certifikati, .scrolling_list").trigger("updateSizesCustom");
		$(".certifikati, .scrolling_list").trigger("updateSizesCustom");
	...
	{
		//google map
		var coordinate = new google.maps.LatLng(46.282091, 16.346143);
		var mapOptions = {
			zoom: 12,
			center: coordinate,
		...
		new google.maps.Marker({
			position: new google.maps.LatLng(46.282091, 16.346143),
			map: map,
